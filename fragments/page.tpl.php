...
<div id="wrapper">
  <header id="header" role="banner">
    ...
    <?php if ($logo): ?><div id="logo2"><img /></div><?php endif; ?>
    <div class="clear"></div>
    <?php
    ...
    if ($main_menu == TRUE):
      ...
      <nav id="main-menu"  role="navigation">
        ...
        <?php global $user; ?>
        <?php if ($user->uid):
		print '<li class="my-user-menu2"><a href="'.base_path().'user/logout">Cerrar sesi&#243;n</a></li>';
		print '<li class="my-user-menu2 first expanded">';
                print l('Bienvenido '.$user->name,'user/'.$user->uid);
                $user_menu_tree = menu_tree(variable_get('menu_user_links_source','user-menu'));
                print drupal_render($user_menu_tree);
		print '</li>';
        ?>
        <?php else:
               print '<li class="my-user-menu2 last"><a href="'.base_path().'user/login">Iniciar sesi&#243;n</a></li>';
	       print '<li class="my-user-menu2"><a href="'.base_path().'user/register">Crear cuenta</a></li>';
        ?>
        <?php endif;?>
	</ul>
        </div>
  ...
  <div id="container">
   ...
   <?php endif; ?>
	...
	<?php if($title): ?><h3 class="page-title my_hidden"><?php print $title; ?></h3><?php endif; ?>
	<?php print render($title_suffix); ?>
      ...
      <section id="post-content" role="main">
        ...
        <?php if ($is_admin and !empty($tabs['#primary'])): ?><div class="tabs-wrapper"><?php print render($tabs); ?></div><?php endif; ?>
        <?php if (!$is_admin and !empty($tabs['#primary']) and drupal_match_path(current_path(),'user/*')): ?><div class="tabs-wrapper"><?php print render($tabs); ?></div><?php endif; ?>
